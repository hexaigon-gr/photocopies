...
export const metadata: Metadata = {
  title: "Επαγγελματικές Κάρτες | Φωτοαντιγραφικό Κέντρο Ηλιούπολης",
  description:
    "Σχεδιασμός και εκτύπωση επαγγελματικών καρτών. Ψηφιακή εκτύπωση υψηλής ποιότητας, πλαστικοποίηση, ειδικά φινιρίσματα.",
};
