...
export const metadata: Metadata = {
  title: "Ψηφιακές Εκτυπώσεις | Φωτοαντιγραφικό Κέντρο Ηλιούπολης",
  description:
    "Ψηφιακές εκτυπώσεις υψηλής ποιότητας σε laser εκτυπωτές. Ασπρόμαυρες, έγχρωμες, μεγάλοι όγκοι, ειδικά χαρτιά.",
};

const services = [
  { key: "laserPrinting", icon: Printer },
  { key: "colorPrinting", icon: Palette },
  { key: "largeBatches", icon: Layers },
...
const DigitalPrintingPage = async ({ params }: BasePageProps) => {
  ...
  const t = await getTranslations("DigitalPrintingPage");
