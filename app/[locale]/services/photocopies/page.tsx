...
const services = [
  { key: "bw", icon: FileText },
  { key: "color", icon: Palette },
  { key: "filePrinting", icon: Printer },
...
const PhotocopiesPage = async ({ params }: BasePageProps) => {
  const { locale } = await params;
  setRequestLocale(locale);
  const t = await getTranslations("PhotocopiesPage");
  ...
  return (
    <>
      ...
      <section className="relative h-[50vh] min-h-[350px] overflow-hidden">
        <Image
          src="/images/services/photocopies.jpg"
          alt={t("title")}
          fill
          priority
...
export default PhotocopiesPage;
