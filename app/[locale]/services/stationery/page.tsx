...
export const metadata: Metadata = {
  title: "Γραφική Ύλη & Αναλώσιμα | Φωτοαντιγραφικό Κέντρο Ηλιούπολης",
  description:
    "Μεγάλη ποικιλία γραφικής ύλης και αναλωσίμων γραφείου σε προσιτές τιμές. Είδη γραφείου, σχολικά, μελάνια και χαρτικά.",
};
...
const StationeryPage = async ({ params }: BasePageProps) => {
  const { locale } = await params;
  setRequestLocale(locale);
  const t = await getTranslations("StationeryPage");
  ...
  return (
    <>
      ...
      <section className="relative h-[50vh] min-h-[350px] overflow-hidden">
        <Image
          src="/images/services/stationery.jpg"
          alt={t("title")}
          fill
          priority
