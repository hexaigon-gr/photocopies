...
interface ExpandMapProps {
  ...
  address: string
  /** Google Maps URL — opened on click */
  mapsUrl: string
  /** Optional coordinates string shown under the address */
  coordinates?: string
  className?: string
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 h-full min-h-[280px] flex flex-col justify-between p-5">
